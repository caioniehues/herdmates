...
two AGENTS.md templates: star emits identity + report protocol only; mesh adds
the peer table and message envelope.
...
- Mesh teams should pair with shared-cwd or explicit merge discipline (see
  ADR-0004); the generated mesh AGENTS.md must carry the anti-chatter policy
